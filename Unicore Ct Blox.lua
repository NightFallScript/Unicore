...
local ver = "1.0.0"
--files
if not isfolder("Unicore") then
    makefolder("Unicore")
end
if not isfolder("Unicore/"..tostring(game.GameId)) then
...
function onStep()
    ...
    if library.flags["watermark_enabled"] then
        ...
        aloraWatermark.Text = "Unicore | v1 | "..hours..":"..minutes..":"..seconds
    end
end
